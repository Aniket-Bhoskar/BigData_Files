...
job = Job(glueContext)
df = spark.read.format('csv').options(sep=",", escape='"', mode="PERMISSIVE", header=True, multiLine=True).load('s3://airbnb-automation-in')
...
output_dir = "s3://airbnb-automation-out"
